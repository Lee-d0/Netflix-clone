        ...
        <div className="flex justify-center items-center mt-20 mx-3">
            ...
            <form className="space-y-4" onSubmit={handleSignUp}>
                <div>
                    ...
                    focus:ontline-none focus-ring" placeholder="you@example.com" id="email" 
                    value={email}
                ...
                <div>
                    ...
                    <input type="text" 
                    className="w-full px-3 py-2 mt-1 border border-gray-700 rounded-md bg-transparent text-white
                    focus:ontline-none focus-ring" placeholder="johndoe" id="username"
                    value={username}
                ...
                <div>
                    ...
                    <input type="password" 
                    className="w-full px-3 py-2 mt-1 border border-gray-700 rounded-md bg-transparent text-white
                    focus:ontline-none focus-ring" placeholder="**********" id="password"
                    value={password}
