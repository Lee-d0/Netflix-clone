        ...
        <div className="mx-auto container px-4 py-8 h-full">
            ...
            {trailers.length > 0 && (
                <div className="flex justify-between items-center mb-4">
                    <button className={`
                        bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded ${currentTrailerId === 0 ? 
                    ...
                    <button className={`
                        bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded ${currentTrailerId === trailers.length -1 ? 
                            'opacity-50 cursor-not-allowed ' : ""}}
            ...
            <div className="aspect-video mb-8 p-2 smpx-10 mdpx-32">
                {trailers.length > 0 && (
                    <ReactPlayer
                    controls={true}
                    width={"100%"}
            ...
            {similerContent.length > 0 && (
                <div className="mt-12 max-w-5xl mx-auto relative">
                    ...
                    <div className="flex overflow-x-scroll scrollbar-hide gap-4 pb-4 group" ref={sliderRef}>
                        ...
                        opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer bg-red-500
