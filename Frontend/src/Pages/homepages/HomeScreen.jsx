  ...
  if(!trendingContent) return (
   ...
   return (
    ...
    <div className="relative h-screen text-white ">
      ...
      {imgLoading && (<div className="absolute top-0 left-0 w-full h-full bg-black/70 flex items-center justify-center -z-10 
      shimmer"/>)}
              ...
              <p className="mt-2 text-lg">
                ...
                <div>
                  <div className="flex mt-8 ">
                    ...
                    <Link to={`/watch/${trendingContent?.id}`} className="bg-white hover:bg-white/80 text-black font-bold py-2 px-4 rounded
